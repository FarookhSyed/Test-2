...
${Lower Boundary String}  aaaaaaaaaaaaaaaaaaaaaaaaaa
${Upper Boundary String}  ABCDEFHJHSKCKSNCKBCDKKCMD
${Mixed Match String}  Aa1!@#$%^&*()_+?><~`-=';:"[]{}
${Numbers}  1234...ee---+++
${upper boundary number}  9999999999999999999999999
${Wrong Email address}   test_1@gmail.com
${Real Email address}   farookh5a5@sasi.ac.in
${Real Phone Number}    9440206296
${Wrong Phone Number}   9876763210
&{a}  a=1  b=2  c=3
                                #data
